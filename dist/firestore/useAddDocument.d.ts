...
type UseAddDocumentDispatcher = (data: DocumentData) => Promise<DocumentReference | undefined>;
type UseAddDocument = {
...
export declare const useAddDocument: (reference: CollectionReference) => UseAddDocument;
export {};
