...
import {
  ...
  createUserWithEmailAndPassword as k,
  deleteUser as C,
  signOut as E,
  sendEmailVerification as U,
} from "firebase/auth";
import {
  signInWithPopup as f,
  sendSignInLinkToEmail as B,
  signInWithEmailAndPassword as x,
} from "@firebase/auth";
import { httpsCallable as O } from "firebase/functions";
import {
  uploadBytes as L,
  uploadBytesResumable as M,
  getDownloadURL as V,
  getBlob as I,
  getBytes as R,
  deleteObject as W,
...
const at = (
    t,
    { listen: s, listenToMetadataChanges: e } = {
      listen: !1,
    ...
    return (
      y(() => {
        ...
        b(t)
          ...
          .catch((u) => {
            if (u instanceof m) i(u), a(!1);
            else throw (a(!1), u);
          })
          .finally(() => a(!1));
      }, [t, s, e]),
      { loading: n, snapshot: r, error: c }
    );
  },
  T = (
    t,
    ...
    return {
      ...
      dispatch: async (o, c) => {
        ...
        try {
          ...
          if (i instanceof m) e("ready"), a(i);
          else throw (e("loading"), i);
          return;
        }
        e("done");
      },
    ...
    return {
      ...
      dispatch: async () => {
        ...
        try {
          ...
          if (o instanceof m) e("ready"), a(o);
          else throw (e("ready"), o);
        }
      },
      error: n,
    };
  ...
  it = ({
    ...
    const { loading: r, snapshot: o, error: c } = T(t, { listen: a });
    return r ? s() : c ? e(c) : n(o);
  },
  _ = w(void 0),
  dt = ({ app: t, children: s }) =>
    /* @__PURE__ */ l(_.Provider, { value: t, children: s }),
  z = w(void 0),
  ut = ({ firestore: t, children: s }) =>
    /* @__PURE__ */ l(z.Provider, { value: t, children: s }),
  Z = w(void 0),
  lt = ({ auth: t, children: s }) =>
    /* @__PURE__ */ l(Z.Provider, { value: t, children: s }),
  G = w(void 0),
  yt = ({ functions: t, children: s }) =>
    /* @__PURE__ */ l(G.Provider, { value: t, children: s }),
  H = w(void 0),
  ht = ({ storage: t, children: s }) =>
    /* @__PURE__ */ l(H.Provider, { value: t, children: s }),
  g = (
    t,
    { onError: s, onChange: e } = {
      onError: () => {},
      onChange: () => {},
    },
  ) => {
    const [n, a] = d(t.currentUser);
    return y(() => A(t, (o) => a(o), s, e), [t, s, e]), n;
  },
  J = (
    t,
    { onError: s, onlyRealAnon: e } = {
      onError: () => {},
      onlyRealAnon: !1,
    },
  ) => {
  ...
  ft = ({
    ...
    switch (r) {
      case "ready":
        return e
          ? e(o)
          : /* @__PURE__ */ l("button", { onClick: o, children: "Sign Out" });
      case "loading":
  ...
  K = {
    isAuthenticated:
      (t = !1) =>
      (s) =>
        s ? (t ? !0 : !s.isAnonymous) : !1,
    isAnonymous:
      (t = !1) =>
      (s) =>
        s ? (t ? !1 : s.isAnonymous) : !0,
    isVerified: () => (t) => (t == null ? void 0 : t.emailVerified) ?? !1,
    every: (t) => async (s) => {
      const e = t.map((o) => o(s)),
        n = e.filter((o) => typeof o == "boolean"),
        a = e.filter((o) => o instanceof Promise),
